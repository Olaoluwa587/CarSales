...
<head>
    ...
    <title>Sotom Automobile LTD</title>
    <link rel="stylesheet" href="../stylesheet/car.css">
...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="car.php" class="link">Home</a>
  ...
  <div class="dropdown-content">
    ...
    <a onclick="window.open('job.php','job')">Apply For Job</a>  </div>
</div>
